...
name: pull-main
model: default
description: Switches to trunk branch, pulls latest changes, repairs git corruption, and cleans up stale/merged local branches. Worktree-aware — detects trunk branch automatically. Supports force mode.
---
