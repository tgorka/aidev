...
name: worktree
model: default
description: Manages git worktrees for parallel development. Supports create, list, status, sync, close, and switch operations. Enables the orchestrator to work across multiple isolated workspaces.
---
